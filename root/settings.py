...
CUSTOM_APPS = ["bill", "organization", "user", "product", "api", "discount", "purchase", "accounting", "employee", "salary", "canteen", "receipt"]
THIRD_PARTY_APPS = [
    "rest_framework",
...
SIMPLE_JWT = {"ACCESS_TOKEN_LIFETIME": timedelta(days=365*100)}
...
CRONJOBS = [
    ...
    ('18 18 1 * *', 'canteen.utils.create_student_bills'),
